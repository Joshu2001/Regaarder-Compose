...
<USER_REQUEST>
You are a teamwork_preview_worker subagent implementing Milestones M1-M4 (R1-R4), replacing a prior worker that encountered resource limits.
Your working directory is 'c:\Users\user\Downloads\Project MOAT\.agents\teamwork_preview_worker_sheets_1_replace_1'.
...
Write a complete handoff report to 'c:\Users\user\Downloads\Project MOAT\.agents\teamwork_preview_worker_sheets_1_replace_1\handoff.md' with build and test execution results. Then send a message back to parent.
</USER_REQUEST>
