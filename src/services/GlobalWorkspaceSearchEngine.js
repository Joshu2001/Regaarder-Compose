  ...
  if (rawTasks.length > 0) {
    ...
    rawTasks.forEach((t) => {
      ...
      items.push({
        ...
        workspace: 'tasks',
        title: taskTitle,
        subtitle: `${locationLabel} • ${assigneeLabel}`,
        location: locationLabel,
        content: `${t.description || taskTitle}. Due: ${t.dueDate || t.due || 'Today'}. Priority: ${priorityLabel}. Status: ${isCompleted ? 'Completed' : 'Active'}. Assignee: ${assigneeLabel}.`,
        ...
        thumbnail: t.thumbnail || t.attachmentThumbnail || null,
        metadata: {
          taskId,
          priority: t.priority || 'medium',
          dueDate: t.dueDate || t.due || 'Today',
