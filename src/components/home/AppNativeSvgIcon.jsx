...
export function AppNativeSvgIcon({ type, size = 24, className = "", variant = "tile" }) {
  ...
  // ---------------------------------------------------------------------------
  if (variant === "minimal") {
    // 0. LEDGER: Crisp Balanced Scales Silhouette with Emerald Invariant Dot
    if (norm.includes("ledger") || norm.includes("book") || norm.includes("account")) {
      return (
        <svg
          width={size}
          height={size}
        ...
        >
          {/* Base plate */}
          <rect x="1.5" y="1.5" width="13" height="13" rx="3.2" fill="#7C3AED" />
          {/* Subtle bottom bevel shelf */}
          <path d="M2.5 13.5C3.5 14.2 4.8 14.5 6.5 14.5H10.5C12.2 14.5 13.5 14.2 14.5 13.5V11.5H1.5V13.5H2.5Z" fill="#5B21B6" opacity="0.6" />
          {/* Scales column & beam */}
          <line x1="8" y1="3.8" x2="8" y2="12.2" stroke="#FFFFFF" strokeWidth="1" strokeLinecap="round" />
          <line x1="4.2" y1="5.5" x2="11.8" y2="5.5" stroke="#FFFFFF" strokeWidth="1" strokeLinecap="round" />
          {/* Left Pan (Debit) */}
          <path d="M3.2 8.5C3.2 9.8 4.2 10.5 5.2 10.5C6.2 10.5 7.2 9.8 7.2 8.5H3.2Z" fill="#DDD6FE" />
          <line x1="4.2" y1="5.5" x2="3.4" y2="8.5" stroke="#FFFFFF" strokeWidth="0.7" />
          <line x1="4.2" y1="5.5" x2="7" y2="8.5" stroke="#FFFFFF" strokeWidth="0.7" />
          {/* Right Pan (Credit) */}
          <path d="M8.8 8.5C8.8 9.8 9.8 10.5 10.8 10.5C11.8 10.5 12.8 9.8 12.8 8.5H8.8Z" fill="#DDD6FE" />
          <line x1="11.8" y1="5.5" x2="9" y2="8.5" stroke="#FFFFFF" strokeWidth="0.7" />
          <line x1="11.8" y1="5.5" x2="12.6" y2="8.5" stroke="#FFFFFF" strokeWidth="0.7" />
          {/* Deterministic Balanced dot */}
  ...
  // ---------------------------------------------------------------------------
  // 0. LEDGER: Balanced Scales Tile with Double-Entry Ledger Substrate
  // ---------------------------------------------------------------------------
  if (norm.includes("ledger") || norm.includes("account") || norm.includes("book")) {
    return (
      <svg
        width={size}
        height={size}
      ...
      >
        <defs>
          <linearGradient id="ledgerBodyGrad" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#8B5CF6" />
            <stop offset="100%" stopColor="#6D28D9" />
          </linearGradient>
          <linearGradient id="ledgerPlateGrad" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        {/* Soft shadow */}
        <rect x="2" y="2.5" width="20" height="20" rx="5.5" fill="#0F172A" opacity="0.1" />

        {/* Main Base Chassis */}
        <rect x="2" y="2" width="20" height="20" rx="5.5" fill="url(#ledgerBodyGrad)" />

        {/* Inner Ledger Surface Plate */}
        <rect x="4.2" y="4.2" width="15.6" height="15.6" rx="3.5" fill="url(#ledgerPlateGrad)" />

        {/* Scales of Invariant Justice */}
        <line x1="12" y1="6" x2="12" y2="17" stroke="#7C3AED" strokeWidth="1.4" strokeLinecap="round" />
        <line x1="7" y1="8" x2="17" y2="8" stroke="#7C3AED" strokeWidth="1.4" strokeLinecap="round" />
        
        {/* Central Pivot fulcrum */}
        <circle cx="12" cy="8" r="1.3" fill="#10B981" />

        {/* Left Pan (Debits) */}
        <path d="M5.5 12C5.5 13.8 6.9 14.8 8.5 14.8C10.1 14.8 11.5 13.8 11.5 12H5.5Z" fill="#EDE9FE" stroke="#7C3AED" strokeWidth="1" />
        <line x1="7" y1="8" x2="5.8" y2="12" stroke="#A78BFA" strokeWidth="0.8" />
        <line x1="7" y1="8" x2="11.2" y2="12" stroke="#A78BFA" strokeWidth="0.8" />

        {/* Right Pan (Credits) */}
        <path d="M12.5 12C12.5 13.8 13.9 14.8 15.5 14.8C17.1 14.8 18.5 13.8 18.5 12H12.5Z" fill="#EDE9FE" stroke="#7C3AED" strokeWidth="1" />
        <line x1="17" y1="8" x2="12.8" y2="12" stroke="#A78BFA" strokeWidth="0.8" />
        <line x1="17" y1="8" x2="18.2" y2="12" stroke="#A78BFA" strokeWidth="0.8" />

        {/* Status Invariant Check */}
        <circle cx="18" cy="5.5" r="2.2" fill="#10B981" />
        <path d="M17 5.5L17.7 6.2L19.2 4.7" stroke="#FFFFFF" strokeWidth="0.8" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  }
