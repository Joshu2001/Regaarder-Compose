...
// 1. Add the Hover Effect
const effectSpot = `  useEffect(() => {
    // -------------------------------------------------------------
    // AI Streaming Setup
    // -------------------------------------------------------------`;
...
if (!app.includes('handleBlockHover')) {
  app = app.replace(effectSpot, hoverEffect);
}

// 2. Add the Hover UI JSX
const jsxSpot = `      {/* ────────────────────────────────────────────────────────── */}
...
if (!app.includes('Advanced Block Hover Menu')) {
  app = app.replace(jsxSpot, hoverJSX);
}

fs.writeFileSync('src/App.jsx', app);
console.log('Advanced Hover UI added.');
